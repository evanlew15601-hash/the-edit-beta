  ...
  if (player.special.kind === 'hosts_estranged_child') {
    ...
    if (!revealed) {
      ...
      prompts.push({
        id: 'hc_post_reveal',
        category: 'reflection',
        prompt: `Now that your connection to Mars Vega has been revealed to the house, ${strongestAlly ? `did ${strongestAlly} handle it well` : 'how did people actually react'}?`,
